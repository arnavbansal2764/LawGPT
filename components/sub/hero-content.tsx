    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5 grid-cols-2">
          <Input id="email" placeholder="Ask Any Question" className="bg-zinc-200 rounded-l-xl p-7 mx-auto " />
          <a className=" relative inline-flex items-center rounded-r-xl justify-center p-4 px-6 py-3 h-14 w-10 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-purple-500 shadow-md group">
            <span className="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-purple-500 group-hover:translate-x-0 ease">
              <svg className="w-6 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
            </span>
